...
require (
	...
	github.com/ofen/getblock-go v0.0.0-20220503173503-b706568eeb4b
...
replace github.com/ofen/getblock-go => github.com/mazay98/getblock-go v0.0.0-20231128170929-f5ccce9c9b58
